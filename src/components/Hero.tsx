  ...
  return <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 py-20">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          duration: 0.8
            ...
            <motion.p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            ...
            <motion.div className="pt-6 flex flex-col sm:flex-row gap-4 justify-center" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            ...
            duration: 0.8
              ...
              <Button size="lg" variant="outline" className="border-proofmint-purple text-proofmint-purple hover:bg-proofmint-soft-purple">
                Learn More
              </Button>
            </motion.div>
          </motion.div>
          
          <motion.div className="mt-16 w-full max-w-3xl" initial={{
          opacity: 0,
          y: 40
        }} animate={{
          opacity: 1,
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-10">
        ...
        repeatType: "reverse"
          ...
          <div className="flex flex-col items-center mx-[110px] rounded-none mt-10">
            <span className="text-sm text-muted-foreground mb-2">Scroll to explore</span>
            <div className="w-6 h-10 border-2 border-muted-foreground rounded-full flex justify-center">
              <motion.div className="w-1 h-2 bg-muted-foreground rounded-full mt-2" animate={{
              y: [0, 12, 0]
            }} transition={{
              duration: 1.5,
              repeat: Infinity
